...
contract UFragmentsPolicy is Ownable {
    ...
    // (eg) An oracle value of 1.5e18 it would mean 1 usnfte is trading for $1.50.
    ...
    // For exusnfte if minRebaseTimeInterval is 24hrs, it represents the time of day in seconds.
